About cyordereddict-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cyordereddict-feedstock/blob/main/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `cyordereddict` can be installed with `conda`:
...
```
mamba install cyordereddict
```

It is possible to list all of the versions of `cyordereddict` available on your platform with `conda`:
...
```
mamba search cyordereddict --channel conda-forge
```
...
mamba repoquery search cyordereddict --channel conda-forge

# List packages depending on `cyordereddict`:
mamba repoquery whoneeds cyordereddict --channel conda-forge

# List dependencies of `cyordereddict`:
mamba repoquery depends cyordereddict --channel conda-forge
```
